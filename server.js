      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
          ...
          <div style="background:#f9f9f9;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e0e0e0">
            ...
            <p style="color:#888;font-size:12px;margin-top:16px">Wiadomość automatyczna — RaportRBR v1.89 © Ready Bathroom</p>
          </div>
        </div>`,
      attachments: [{
...
async function collectBackupPayload() {
  ...
  return { version: '1.89', exportedAt: new Date().toISOString(), data, counts };
}
...
ensureInitialAdminAccount().finally(() => {
  app.listen(PORT, () => console.log(`RaportRBR v1.89 running on port ${PORT}`));
});
